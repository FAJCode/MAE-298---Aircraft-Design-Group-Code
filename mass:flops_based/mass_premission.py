...
# add import strut mass
from aviary.subsystems.mass.flops_based.strut import StrutMass
...
class MassPremission(om.Group):
    ...
    def setup(self):
        ...
        # add strut mass
        self.add_subsystem('strut', StrutMass(), promotes_inputs=['*'], promotes_outputs=['*'])
