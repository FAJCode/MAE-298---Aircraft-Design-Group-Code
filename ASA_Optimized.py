    ...
    'climb': {
        ...
        'user_options': {
            ...
            'order': 3,
                ...
                'time_duration_bounds': ((12.1, 160.0), 'min'),
                'no_descent': True,
        },
        'initial_guesses': {
            'time': ([0, 60.0], 'min'),
    ...
    'descent': {
        ...
        'user_options': {
            'num_segments': 10,
                ...
                'time_duration_bounds': ((25.0, 80.0), 'min'),
                'no_climb': True,
            },
...
#                 'altitude_bounds': ((0.0, 38000.0), 'ft'),
#                 'throttle_enforcement': 'boundary_constraint', #'path_constraint',
#                 'time_initial_bounds': ((0.0, 0.0), 'min'),
...
#                 'mach_initial': (0.75, 'unitless'),
#                 'mach_final': (0.75, 'unitless'),
#                 'mach_bounds': ((0.7, 0.84), 'unitless'),
#                 'altitude_optimize': False,
#                 'altitude_polynomial_order': 2,
