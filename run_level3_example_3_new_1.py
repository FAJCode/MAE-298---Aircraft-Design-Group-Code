...
'''
# Add span calculation from aspect ratio
...
csv_path = 'models/aircraft/advanced_single_aisle_new/advanced_single_aisle_FLOPS.csv'
...
aviary_inputs.set_val(Mission.Summary.RANGE, 3000.0, units='NM')
prob.require_range_residual = True
prob.target_range = 3000.0
...
prob.traj._phases['cruise'].set_time_options(
    duration_bounds=(3390, 27000),
    duration_ref=25000.0,
)
...
prob.add_driver('IPOPT', max_iter=100, verbosity=Verbosity.BRIEF)
...
guesses = {}
guesses['mach_climb'] = ([0.2, 0.76], 'unitless')
guesses['altitude_climb'] = ([0, 32000.0], 'ft')
guesses['time_climb'] = ([0, 3840.0], 's')
guesses['mach_cruise'] = ([0.76, 0.76], 'unitless')
guesses['altitude_cruise'] = ([32000.0, 34000.0], 'ft')
guesses['time_cruise'] = ([3840.0, 25000.0], 's')
guesses['mach_descent'] = ([0.76, 0.36], 'unitless')
